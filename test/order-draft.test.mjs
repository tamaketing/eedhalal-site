...
test('order drafts preserve a stable reference and normalize the kitchen snapshot', () => {
  ...
  const first = api.save({
    ...
    shipping: { mode: 'zone', fee: 60, text: '60 บาท' },
    items: [{ id: 1, name: 'ข้าวกะเพราไก่', quantity: 10, options: ['ไก่'], unitPrice: 60, total: 600 }],
    totals: { requestedQuantity: 10, selectedQuantity: 10, food: 600, shipping: 60, grand: 660 },
  });
