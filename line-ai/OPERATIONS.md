...
## Workflow changes
- Run `node scripts/check-system.mjs --write` after changing the prompt or menu source; this synchronizes the knowledge pack, combined system message, template agent prompt, deterministic router parser, candidate menu-lookup branch, and draft revision.
