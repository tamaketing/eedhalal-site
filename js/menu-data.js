...
var EED_MENUS = [
  ...
  { id: 19, name: "กระเพราทะเลไข่ดาว", price: 90, category: "ข้าวราดแกง", image: "img/กระเพราทะเลไข่ดาว.png", desc: "ผัดกระเพราทะเลรวม กุ้ง หมึก หอย + ไข่ดาว", badge: "", minPerMenu: 5 },
  ...
  { id: 29, name: "ข้าวผัดกะเพราเนื้อ + ผลไม้", price: 75, category: "ข้าวราดแกง", image: "img/กะเพราเนื้อ_ผลไม้.jpg", desc: "เพิ่มผลไม้สดตามฤดูกาล", badge: "+ ผลไม้", minPerMenu: 5 },
  { id: 30, name: "ข้าวผัดทะเล + ผลไม้", price: 75, category: "ข้าวผัด", image: "img/ข้าวผัดทะเล_ผลไม้.jpg", desc: "ข้าวผัดทะเลเสิร์ฟพร้อมผลไม้", badge: "+ ผลไม้", minPerMenu: 5 },
