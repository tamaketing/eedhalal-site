...
**ตั้งแต่ 8/9/2026:** กฎธุรกิจอยู่ที่ `data/business-rules.json` และข้อมูลเมนู/ค่าส่งอยู่ที่ `data/planner-overrides.json` ส่วน `js/business-data.js` และฐานความรู้ AI เป็นไฟล์ที่ต้องสร้างและตรวจให้ตรงด้วย `node scripts/check-system.mjs --write`
...
| พื้นที่บริการ | ทั่วกรุงเทพฯ (ส่งฟรีตามเขต: ชั้นใน 50+, สุขุมวิท/ลาดพร้าว 75+, รอบนอก 100+ กล่อง) ปริมณฑลไม่มีส่งฟรี ต่างจังหวัดรายกรณี |
